...
import { CaseBattleLogo, SiteFooter, SiteHeader } from "./site-shell";
    ...
    <main className="site-root home-page">
      ...
      <section className="home-hero" aria-labelledby="home-title">
        ...
        <div className="floating-game-elements" aria-hidden="true">
          <img className="floating-piece floating-vs" src="/floating/ref-vs-badge.png" alt="" />
          <img className="floating-piece floating-x10" src="/floating/ref-x10-star.png" alt="" />
          <img className="floating-piece floating-cat" src="/floating/ref-cat-mascot.png" alt="" />
          <img className="floating-piece floating-scatter" src="/floating/ref-scatter-machine.png" alt="" />
        </div>
        ...
        <div className="case-poster-wrap" aria-hidden="true">
          ...
          <div className="case-poster">
            ...
            <div className="poster-copy">
              <CaseBattleLogo className="casebattle-logo-poster" />
              <strong className="poster-outline poster-battles-label">BATTLES</strong>
            </div>
            <div className="poster-bottom"><span>CASE BATTLES</span><span className="poster-arrow">↘</span></div>
      ...
      <div className="chaos-tape" aria-hidden="true">
        <div className="chaos-tape-track">
          <span>CASE BATTLES</span><i>✦</i><span>TAKE THE TABLE</span><i>✦</i><span>DIRTYGAMBLERS</span><i>✦</i>
          <span>CASE BATTLES</span><i>✦</i><span>TAKE THE TABLE</span><i>✦</i><span>DIRTYGAMBLERS</span><i>✦</i>
        </div>
      </div>
      ...
      <section className="leaderboard-callout" aria-labelledby="callout-title">
        ...
        <h2 id="callout-title">THE TABLE<br /><em>REMEMBERS.</em></h2>
